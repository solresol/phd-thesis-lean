...
export LeanNPHardness.BoundedPrime
  (primeCandidates mem_primeCandidates_iff primeCandidates_nonempty selectPrimeAbove selectPrimeAbove_zero
   selectPrimeAbove_mem_primeCandidates selectPrimeAbove_prime lt_selectPrimeAbove selectPrimeAbove_le_two_mul selectPrimeAbove_lt_two_mul
   selectPrimeAbove_one)

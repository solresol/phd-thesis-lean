...
redundant codec. Composing these passes from the actual compiler input through
the original Boolean framing bridge remains open.
...
header conversion and raw assembly are now checked; their composition from
the actual input through the original Boolean framing bridge remains.
...
payload encoding. The outer row counter and binary-header machine are now
checked; composition from the actual input through Boolean framing remains;

...
reversal contract. Computing the record count and executing the final
header/section merge remain open.
...
record-count construction and complete structural machine assembly remain
absent; the variable count now survives the composed section processing;

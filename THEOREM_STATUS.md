...
increment implements and composes the complete scope-section machine in
`AllDifferentCSPScopeMachine.lean`. `ScopeSectionMachine.computer` uses five
...
present; source splitting, executable header staging, and their assembly into
...
actual compiler input bit length. Source splitting, executable

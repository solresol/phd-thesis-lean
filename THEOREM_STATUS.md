...
increment is the complete indexed domain-section machine.
...
actual compiler input bit length. Composition with the header-removal pass,
the scope-section loop, variable/record-count staging, and complete structural
output assembly remain absent;

...
variables and trailing empty domains. Carrying the count through both section
passes, constructing the record count, and full structural assembly remain open.
...
now also compose from that input. Carrying the count through section processing,
record-count construction, and full structural assembly remain.
...
retained-count/section composition, record-count construction, and complete
structural machine assembly remain absent;
